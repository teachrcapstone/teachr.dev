			...
			<div class="row">
				<div class="col-xs-8 col-xs-offset-2 col-md-4 col-md-offset-0 col-lg-4 col-lg-offset-0">
					<figure>
						...
						<img class="img-responsive" src="/img/eric400.png">
						<figcaption class="text-center">
							<h3>Eric Pharr</h3>
							<a href="http://ericpharr.info" target="_blank"><p class="text-default"><i class="fa fa-user fa-md icon" aria-hidden="true"></i> ericpharr.info</p></a>
							<a href="mailto:ericjpharr@gmail.com"><p><i class="fa fa-envelope fa-md icon"></i> ericjpharr@gmail.com</p></a>
							<a href="https://github.com/ericpharr" target="_blank"><p><i class="fa fa-github fa-md icon" aria-hidden="true"></i> ericpharr</p></a>
						</figcaption>
					</figure>
				</div>
				<div class="col-xs-8 col-xs-offset-2 col-md-4 col-md-offset-0 col-lg-4 col-lg-offset-0">
